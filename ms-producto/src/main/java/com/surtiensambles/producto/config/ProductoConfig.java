package com.surtiensambles.producto.config;
...
@EnableJpaRepositories(entityManagerFactoryRef = "managerFactory", transactionManagerRef = "transactionManager", basePackages = "com.surtiensambles.producto.dao")
@ComponentScan(basePackages = {	    
	    "com.surtiensambles.producto.service",
	    "com.surtiensambles.producto.serviceImpl",
	    "com.surtiensambles.producto.controller"
	})
...
//        dataSource.setConnectionTimeout(env.getProperty("primaryDB.datasource.hikari.connection-timeout"));
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		emf.setPackagesToScan("com.surtiensambles.producto.entity");
