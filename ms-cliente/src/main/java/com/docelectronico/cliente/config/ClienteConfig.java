package com.docelectronico.cliente.config;
...
@EnableJpaRepositories(entityManagerFactoryRef = "managerFactory", transactionManagerRef = "transactionManager", basePackages = "com.docelectronico.cliente.dao")
...
//        dataSource.setConnectionTimeout(env.getProperty("primaryDB.datasource.hikari.connection-timeout"));
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		emf.setPackagesToScan("com.docelectronico.cliente.entity");
