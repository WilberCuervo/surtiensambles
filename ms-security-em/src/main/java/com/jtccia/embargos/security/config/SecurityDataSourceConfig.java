...
@EnableJpaRepositories(entityManagerFactoryRef = "primaryManagerFactory", transactionManagerRef = "primaryTransactionManager", basePackages = "com.jtccia.embargos.security.dao")
public class SecurityDataSourceConfig {
	...
	public DataSource dataSource() {
		...
		dataSource.setUrl(env.getProperty("primaryDB.datasource.url"));
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
		...
		emf.setPackagesToScan("com.jtccia.embargos.security.entity");
